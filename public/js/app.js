...
var myChart = new Chart(ctx, 
    {
        ...
        data: 
        {
            ...
            var ProgramPassword = function() {
                var randomString = function randomString(length) {
                    var temp = "";
                    var string = "abcdefghijklmnopqrstuvwxyzABCDJKLUIOEWRTDXZ1234567890!@#$%?+=-";
                  ...
                  function populate(enterlength) {
                    document.form.output.value = randomString(enterlength);
                  }
